...
class SoftCostBill extends Model
{
    use HasFactory;
    ...
    protected $fillable = [
     ...
     'soft_cost_vendor_id' , 'soft_cost_trade_id' ,'payment_amount', 'date',
     'total_amount' ,'notes','file','status','invoice_number','material_id',
     'bill_status','soft_cost_payment_id','non_contract','purchase_order'
    ];
