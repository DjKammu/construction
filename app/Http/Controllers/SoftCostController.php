    ...
    public function index($id)
    {
       ...
       if(request()->filled('orderLog')){
        ...
        // }); 
         ...
         return view('projects.soft_cost.index',compact('projectTypes','propertyTypes','project','documentTypes','documents','subcontractors','vendors','trades','projects','trade','proposals','awarded',
