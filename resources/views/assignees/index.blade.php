...
@section('title', 'RFI/Submittal Assignees')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">RFI/Submittal Assignees List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='assignees/create'">Add RFI/Submittal Assignees
                        </button>
                    </div>
                </div>
                <!-- Categories Table -->
                <div class="table-responsive">
                    <table id="project-types-table" class="table table-hover text-center">
                        ...
                        <tr class="text-danger">
                            ...
                            <th>Assignee <span class="sorting-outer">
                        ...
                        <tbody>
                         ...
                         <tr>
                           <td> {{ $assignee->account_number }}</td>
                           <td>{{ $assignee->name }}</td>
                           <td>        
                            <button onclick="return window.location.href='assignees/{{$assignee->id}}'" rel="tooltip" class="btn btn-neutral bg-transparent btn-icon" data-original-title="Edit RFI/Submittal Assignee" title="Edit RFI/Submittal Assignee">            <i class="fa fa-edit text-success"></i>        </button> 
                          </td>
                          <td>
                             <form 
                              method="post" 
                              action="{{route('assignees.destroy',$assignee->id)}}"> 
                               @csrf
                              {{ method_field('DELETE') }}
                              ...
                              <button 
                                ...
                                class="btn btn-neutral bg-transparent btn-icon" data-original-title="Delete RFI/Submittal Assignee" title="Delete RFI/Submittal Assignee"><i class="fa fa-trash text-danger"></i> </button>
                            </form>
                           </td>
                         </tr> 
                         @endforeach
