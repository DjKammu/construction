...
@section('title', 'Soft Cost Categories')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Soft Cost Categories List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='categories/create'">Add Soft Cost Category
                        </button>
                    </div>
                </div>
                <!-- Categories Table -->
                <div class="table-responsive">
                    <table id="Category-types-table" class="table table-hover text-center">
                        ...
                        <tr class="text-danger">
                            ...
                            <th>Soft Cost Category<span class="sorting-outer">
                        ...
                        <tbody>
                         ...
                         <tr>
                           ...
                           <td>{{ $type->name }}</td>
                           <td>        
                            <button onclick="return window.location.href='categories/{{$type->id}}'" rel="tooltip" class="btn btn-neutral bg-transparent btn-icon" data-original-title="Edit Category Type" title="Edit Soft Cost Category">            <i class="fa fa-edit text-success"></i>        </button> 
                          </td>
                          <td>
                             <form 
                              method="post" 
                              action="{{route('soft-cost.categories.destroy',$type->id)}}"> 
                               @csrf
                              {{ method_field('DELETE') }}
                              ...
                              <button 
                                ...
                                class="btn btn-neutral bg-transparent btn-icon" data-original-title="Delete Soft Cost Category" title="Delete Soft Cost  Category"><i class="fa fa-trash text-danger"></i> </button>
                            </form>
                           </td>
                         </tr> 
                         @endforeach
