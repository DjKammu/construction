                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input  name="name" value="{{ $subcontractor->name}}" type="text" class="form-control" placeholder="Property Name" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input  name="contact_name"  value="{{ $subcontractor->contact_name }}" type="text" class="form-control" placeholder="Conatct Name" >
                                            </div>
                                        </div>
