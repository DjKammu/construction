...
@section('title', 'Soft Cost Trades')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Soft Cost Trades List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='{{ route("soft-cost.trades.create")}}'">Add Soft Cost Trade
                        </button>
                    </div>
                </div>
                <!-- Categories Table -->
                <div class="table-responsive">
                      <table id="project-types-table" class="table table-hover text-center">
                        ...
                        <tr class="text-danger">
                            ...
                            <th>FFE Trade<span class="sorting-outer">
                        ...
                        <tbody>
                         ...
                         <tr>
                          ...
                          <td>
                             <form 
                              method="post" 
                              action="{{route('soft-cost.trades.destroy',$type->id)}}"> 
                               @csrf
                              {{ method_field('DELETE') }}
