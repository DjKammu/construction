    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">FFE Vendors List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='vendors/create'">Add FFE Vendor
                        </button>
                    </div>
                </div>
                               ...
                               <td>
                                  <a style="text-decoration: none; position: relative;" href="vendors/{{ $vendor->id }}">
                                    <span class="cross"> 
                                     <form 
                                        method="post" 
                                        action="{{route('ffe.vendors.destroy',$vendor->id)}}"> 
                                         @csrf
                                         @method('DELETE')
                                        ...
                                        <button 
                                          ...
                                          class="btn btn-neutral bg-transparent btn-icon" data-original-title="Delete FFE Vendor" title="Delete FFE Vendor"><i class="fa fa-trash text-danger"></i> </button>
                                      </form>
                                    </span>
