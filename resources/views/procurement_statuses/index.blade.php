...
@section('title', 'Procurement Statuses')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Procurement Statuses List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='procurement-statuses/create'">Add Procurement Status
                        </button>
                    </div>
                </div>
                <!-- Categories Table -->
                    ...
                    <table id="project-types-table" class="table table-hover text-center">
                        ...
                        <tbody>
                         ...
                         <tr>
                           ...
                           <td>{{ $status->name }}</td>
                           <td>        
                            <button onclick="return window.location.href='procurement-statuses/{{$status->id}}'" rel="tooltip" class="btn btn-neutral bg-transparent btn-icon" data-original-title="Edit Ball In Court" title="Edit Ball In Court">            <i class="fa fa-edit text-success"></i>        </button> 
                          </td>
                          <td>
                             <form 
                              method="post" 
                              action="{{route('procurement-statuses.destroy',$status->id)}}"> 
                               @csrf
                              {{ method_field('DELETE') }}
                              ...
                              <button 
                                ...
                                class="btn btn-neutral bg-transparent btn-icon" data-original-title="Delete Payment Status" title="Delete Payment Status"><i class="fa fa-trash text-danger"></i> </button>
                            </form>
                           </td>
                         </tr> 
                         @endforeach
