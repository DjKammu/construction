...
@section('title', 'Inspection Categories')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Inspection Categories List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='inspection-categories/create'">Add Inspection Category
                        </button>
                    </div>
                </div>
                <!-- Categories Table -->
                <div class="table-responsive">
                    <table id="Category-types-table" class="table table-hover text-center">
                        ...
                        <tr class="text-danger">
                            ...
                            <th>Inspection Category <span class="sorting-outer">
                        ...
                        <tbody>
                         ...
                         <tr>
                           ...
                           <td>{{ $type->name }}</td>
                           <td>        
                            <button onclick="return window.location.href='inspection-categories/{{$type->id}}'" rel="tooltip" class="btn btn-neutral bg-transparent btn-icon" data-original-title="Edit Category Type" title="Edit Category">            <i class="fa fa-edit text-success"></i>        </button> 
                          </td>
                          <td>
                             <form 
                              method="post" 
                              action="{{route('inspection-categories.destroy',$type->id)}}"> 
                               @csrf
                              {{ method_field('DELETE') }}
