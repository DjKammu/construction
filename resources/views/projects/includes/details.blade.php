               ...
               <div class="col-lg-6 col-md-6">
                ...
                <div class="col-lg-6 col-md-6">
                   ...
                   <div class="form-group">
                        ...
                        <input  name="total_construction_sq_ft" value="{{ $project->total_construction_sq_ft }}" type="number" class="form-control" placeholder="Total Construction Sq Ft" step="any">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6">
                   ...
                   <div class="form-group">
                        ...
                        <input  name="hotel_keys" value="{{ $project->hotel_keys }}" type="number" class="form-control" placeholder="Hotel Keys" step="any">
                    </div>
                </div>
                 ...
                 <div class="col-lg-6 col-md-6">
                   ...
                   <div class="form-group">
                        ...
                        <input  name="subcontractor_retainage" value="{{ $project->subcontractor_retainage }}" type="number" class="form-control" placeholder="Subcontractor Retainage" step="any">
                    </div>
                </div>
