                                    ...
                                    <tr class="text-center col-lg-2 col-sm-3 odd" style="display: flex; flex-wrap: wrap;" role="row">
                                       <td>
                                            <span class="cross"> 
                                             <form 
                                                method="post" 
                                                action="{{route('projects.ffe.logs.file.destroy', ['project'=> request()->project,'id' => request()->id])}}?path={{$log->invoice}}"> 
                                                 @csrf
                                                {{ method_field('DELETE') }}
                                    ...
                                    <tr class="text-center col-lg-2 col-sm-3 odd" style="display: flex; flex-wrap: wrap;" role="row">
                                       <td>
                                            <span class="cross"> 
                                             <form 
                                                method="post" 
                                                action="{{route('projects.ffe.logs.file.destroy', ['project'=> request()->project,'id' => request()->id])}}?path={{$log->po_sent_file}}"> 
                                                 @csrf
                                                {{ method_field('DELETE') }}
