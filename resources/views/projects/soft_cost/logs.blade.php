<div class="tab-pane" id="logs" role="tabpanel" aria-expanded="true">
   <div class="row mb-2">
         <div class="col-6">
            <h4 class="mt-0 text-left">{{ @$project->name }} - Soft Cost Procurement Log </h4>
        </div>
        <div class="col-6 text-right">
            <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='{{ route("projects.soft-cost.logs",['project' => request()->project ])  }}'">Add Procurement Log
            </button>
        </div>
        <div class="col-6"> 
         <form>
        ...
        <div class="col-6 text-right">
           <button type="button" class="btn btn-danger mt-0"  onclick="sendEmailLogsPopup()">
            ...
            <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='soft-cost/download/logs'">Download
            </button>
        </div>
 ...
 <div class="table-responsive table-payments">
       ...
       <table id="project-types-table" class="table table-hover text-center payments-table">
            ...
            <td>{{ @$log->notes }}</td>
            <td>        
                    <button onclick="return window.location.href='soft-cost/logs/{{$log->id}}'" rel="tooltip" class="btn btn-neutral bg-transparent btn-icon" data-original-title="Edit Project Type" title="Edit Project Type">            <i class="fa fa-edit text-success"></i>        
                    </button> 
                  </td>
              <td>
                 <form 
                  method="post" 
                  action="{{route('projects.soft-cost.logs.destroy',[ 'project' => request()->project ,
                  'id' => $log->id]).'#logs'}}"> 
                   @csrf
                  {{ method_field('DELETE') }}
