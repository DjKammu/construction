    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left"> {{ @$payment->project->name }} -  Make Soft Cost Payment </h4>
                    </div>
                </div>
               ...
               <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <form   method="post" 
                              action="{{ route('projects.soft-cost.payments.update',['project' => request()->project, 'id' => $payment->id]) }}" enctype="multipart/form-data">
                                  @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select onchange="return window.location.href ='?trade='+this.value" class="form-control" name="0_soft_cost_trade_id">
                                                  @foreach($trades as $trade)
                                                   ...
                                                   @$payment->soft_cost_trade_id == $trade->id ? 'selected' : '' 
                                                   }}>{{ $trade->name}}
                                                   </option>
                                                  @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-5 col-md-6 mx-auto">
                                           <div class="form-group">
                                                  ...
                                                  <select class="form-control" name="0_soft_cost_vendor_id"> 
                                                     <option value="{{ @$payment->soft_cost_vendor_id }}" >{{ @$payment->vendor->name}}
                                                     </option>
                                                  </select>
                                              </div>
                                        </div>
                                                  ...
                                                  <select class="form-control" name="1_soft_cost_vendor_id"> 
                                                    ...
                                                    @foreach(@$vendors as $vendor)
                                                     <option value="{{ $vendor->id }}" {{ 
                                                      ($payment->soft_cost_vendor_id == $vendor->id ) ? 'selected' : ''}} >{{ $vendor->name}}
                                                     </option>
                                                    @endforeach
                                                  </select>
                                              </div>
                                        ...
                                        <div class="col-lg-5 col-md-6 mx-auto">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="1_soft_cost_vendor_id"> 
                                                  <option value="">Select Vendor</option>
                                                  @foreach(@$vendors as $vendor)
                                                   <option value="{{ $vendor->id }}" {{ ($payment->soft_cost_vendor_id == $vendor->id ) ? 'selected' : ''}}>{{ $vendor->name}}
                                                   </option>
                                                  @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <tr class="text-center col-lg-2 col-sm-3 odd" style="display: flex; flex-wrap: wrap;" role="row">
                                       <td>
                                            <span class="cross"> 
                                             <form 
                                                method="post" 
                                                action="{{route('projects.soft-cost.payments.file.destroy', ['project' => request()->project, 'id' => $payment->id])}}?path={{$payment->file}}"> 
                                                 @csrf
                                                {{ method_field('DELETE') }}
                                    ...
                                    <tr class="text-center col-lg-2 col-sm-3 odd" style="display: flex; flex-wrap: wrap;" role="row">
                                       <td>
                                            <span class="cross"> 
                                             <form 
                                                method="post" 
                                                action="{{route('projects.soft-cost.payments.file.destroy', ['project' => request()->project, 'id' => $payment->id])}}?path={{$payment->unconditional_lien_release_file}}"> 
                                                 @csrf
                                                {{ method_field('DELETE') }}
                                    ...
                                    <tr class="text-center col-lg-2 col-sm-3 odd" style="display: flex; flex-wrap: wrap;" role="row">
                                       <td>
                                            <span class="cross"> 
                                             <form 
                                                method="post" 
                                                action="{{route('projects.soft-cost.payments.file.destroy', ['project' => request()->project, 'id' => $payment->id])}}?path={{$payment->conditional_lien_release_file}}"> 
                                                 @csrf
                                                {{ method_field('DELETE') }}
                                    ...
                                    <tr class="text-center col-lg-2 col-sm-3 odd" style="display: flex; flex-wrap: wrap;" role="row">
                                       <td>
                                            <span class="cross"> 
                                             <form 
                                                method="post" 
                                                action="{{route('projects.soft-cost.payments.file.destroy', ['project' => request()->project, 'id' => $payment->id])}}?path={{$payment->purchase_order}}"> 
                                                 @csrf
                                                {{ method_field('DELETE') }}
