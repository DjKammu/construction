    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left"> {{ @$proposal->project->name }} -  Soft Cost Make Bill </h4>
                    </div>
                </div>
               ...
               <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <form   method="post" 
                              action="{{ route('projects.soft-cost.bills.store',['project' => request()->project,'id' => (@$proposal->id) ? @$proposal->id : 0 ]) }}"
