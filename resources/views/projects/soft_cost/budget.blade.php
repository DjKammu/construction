   ...
   <div class="row mb-2">
        <div class="col-6">
         ...
         <div class="col-6 text-right">
            ...
            <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='soft-cost/budget/download'">Download
            </button>
        </div>
    </div>

<div id="proposals-list" class="row py-3">
 @include('projects.soft_cost.budget-content')
