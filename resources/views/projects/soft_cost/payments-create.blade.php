              ...
              <div class="row mb-2">
               ...
               <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <form   method="post" 
                              action="{{ route('projects.soft-cost.payments.store',['id' => (@$proposal->id) ? @$proposal->id : 0 , 'project' => request()->project ]) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select onchange="return window.location.href ='?trade='+this.value" class="form-control" name="0_soft_cost_trade_id"> 
                                                  @foreach($trades as $trade)
                                                   ...
                                                   $proposal->soft_cost_trade_id == $trade->id ? 'selected' : '' 
                                                   }}>{{ $trade->name}}
                                                   </option>
                                                  @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                  <label class="text-dark" for="password">Vendor
                                                   ...
                                                   <select class="form-control" name="0_soft_cost_vendor_id"> 
                                                     <option value="{{ @$proposal->soft_cost_vendor_id }}" >{{ @$proposal->vendor->name}}
                                                     </option>
                                                  </select>
                                              </div>
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col-12 text-center">
                                      <input type="hidden" name="project_id" value="{{ $id }}" />
                                        <button id="change-password-button" type="submit" class="btn btn-danger">Create Soft Cost Payment
                                        </button>
                                    </div>
