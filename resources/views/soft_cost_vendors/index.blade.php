...
@section('title', 'Soft Cost Vendors')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Soft Cost Vendors List</h4>
                    </div>
                    <div class="col-6 text-right">
                        <button type="button" class="btn btn-danger mt-0"  onclick="return window.location.href='vendors/create'">Add Soft Cost Vendor
                        </button>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                     <div class="col-6">
                      ...
                      <option>Select Soft Cost Trade</option>
                         ...
                         <tbody class="row">
                          @foreach($vendors as $vendor)
                            <tr class="text-center col-lg-4 col-sm-6 odd" style="display: flex; flex-wrap: wrap;" role="row">
                               <td>
                                  <a style="text-decoration: none; position: relative;" href="vendors/{{ $vendor->id }}">
                                    <span class="cross"> 
                                     <form 
                                        method="post" 
                                        action="{{route('soft-cost.vendors.destroy',$vendor->id)}}"> 
                                         @csrf
                                         @method('DELETE')
                                        ...
                                        <button 
                                          ...
                                          class="btn btn-neutral bg-transparent btn-icon" data-original-title="Delete Soft Cost Vendor" title="Delete Soft Cost Vendor"><i class="fa fa-trash text-danger"></i> </button>
                                      </form>
                                    </span>
                                     <div class="card card-user card-table-item" style="width: 100%; height: 100%;">
                                        <div class="card-body pb-0">
                                           <div class="author mt-1">
                                              <img class="avatar border-gray" src="{{ ($vendor->photo) ? url(\Storage::url($vendor->photo)) : asset('img/image_placeholder.png') }}">                        
                                              <h5 class="title mb-0">{{ $vendor->name }}</h5>
                                           </div>
                                        </div>
                                     </div>
                                  </a>
