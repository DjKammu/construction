    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Add Soft Cost Vendor</h4>
                    </div>
                </div>
               ...
               <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <form   method="post" 
                              action="{{ route('soft-cost.vendors.store') }}" enctype="multipart/form-data">
                                  @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input  name="name" value="{{ old('name')}}" type="text" class="form-control" placeholder="Soft Cost Vendor Name" required="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 text-center">
                                        <button id="change-password-button" type="submit" class="btn btn-danger">Create Soft Cost Vendor
                                        </button>
                                    </div>
