    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Edit Category</h4>
                    </div>
                </div>
               ...
               <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <form   method="post" 
                              action="{{ route('categories.update',$type->id) }}">
                              <input type="hidden" name="_method" value="PUT">
                                  @csrf
                                    ...
                                    <div class="col-12 text-center">
                                        <button id="change-password-button" type="submit" class="btn btn-danger">Update Category
                                        </button>
                                    </div>
